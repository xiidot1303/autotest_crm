lang_dict = {
    ...
    "lesson1": ["1-Dars", "Урок 1"],

    "lesson2": ["2-Dars", "Урок 2"],

    "lesson3": ["3-Dars", "Урок 3"],

    "lesson4": ["4-Dars", "Урок 4"],

    "lesson5": ["5-Dars", "Урок 5"],

    "lesson6": ["6-Dars", "Урок 6"],

    "lesson7": ["7-Dars", "Урок 7"],

    "lesson8": ["8-Dars", "Урок 8"],

    "lesson9": ["9-Dars", "Урок 9"],

    "lesson10": ["10-Dars", "Урок 10"],

    "start": ["Boshlash", "Начать"],

    "end": ["Tugash", "Закончить"],
